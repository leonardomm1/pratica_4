...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './padaria.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PADARIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PADARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PADARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PADARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PADARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PADARIA actions', async () => {
      const expectedActions = [
        {
