...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSINATURA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSINATURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSINATURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSINATURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSINATURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSINATURA actions', async () => {
      const expectedActions = [
        {
