...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMSASSINATURA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ITEMSASSINATURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ITEMSASSINATURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ITEMSASSINATURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ITEMSASSINATURA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ITEMSASSINATURA actions', async () => {
      const expectedActions = [
        {
