...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './informacoes-adicionais.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFORMACOESADICIONAIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_INFORMACOESADICIONAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INFORMACOESADICIONAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INFORMACOESADICIONAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INFORMACOESADICIONAIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INFORMACOESADICIONAIS actions', async () => {
      const expectedActions = [
        {
